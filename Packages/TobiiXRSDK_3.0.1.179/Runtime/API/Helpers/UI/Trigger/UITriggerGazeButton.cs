    ...
    public class UITriggerGazeButton : MonoBehaviour, IGazeFocusable
    {
        ...
        {        
            ...
            if (_currentButtonState == ButtonState.Focused &&
                ControllerManager.Instance.GetButtonPressDown(ControllerButton.Touchpad))
            {
                UpdateState(ButtonState.PressedDown);
            }
            // When the trigger button is released.
            else if (ControllerManager.Instance.GetButtonPressUp(ControllerButton.Touchpad))
            {
        ...
        public void GazeFocusChanged(bool hasFocus)
        {
            ...
            if (ControllerManager.Instance.GetButtonPress(ControllerButton.Touchpad)) return;
