...
public class RunCraiyonOnline: MonoBehaviour
{
    ...
    public void StartAI()
    {
        ...
        UnityEngine.Debug.Log("Writing: " + "python run_craiyon_online.py");
        streamWriter.WriteLine($"py run_craiyon_online.py --prompt " + "\"" + prompt + "\"");
    }
